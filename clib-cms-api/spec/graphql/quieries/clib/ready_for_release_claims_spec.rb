...
module Queries
  module Clib
    RSpec.describe ReadyForReleaseClaims, type: :request do
      describe '.resolve' do
        ...
        context 'when limit is 2 and page is 1', :vcr do
          it 'returns 2 records' do
            ...
            expect(json['data']['readyForReleaseClaims']['totalResult']).to eq '0'
            expect(json['data']['readyForReleaseClaims']['claims']).to eq []
          end
        end
